  ...
  return (
    <BaseCard href="/contact">      <div
      ...
      >
        ...
        <EnvelopeIcon className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 text-white transition-transform duration-300 group-hover:scale-110" />
      </div>
