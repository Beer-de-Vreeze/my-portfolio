      ...
      <div className="w-full max-w-5xl flex flex-row justify-between items-center gap-2 sm:gap-3 px-2 sm:px-4 relative z-10 pointer-events-auto">
        ...
        >
          <div className="relative px-2 sm:px-4 py-2 bg-linear-to-r from-gray-900/80 to-gray-800/80 border border-gray-700/50 rounded-full flex items-center justify-center backdrop-blur-xs">
            ...
            <div className="hidden sm:block absolute -top-10 left-1/2 -translate-x-1/2 opacity-0 group-hover/copyright:opacity-100 transition-opacity duration-500 pointer-events-none z-50">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-green-500/70"></div>
            </div>
          </div>
        </div>
